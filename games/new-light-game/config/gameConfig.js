(function (global) {
  ...
  const MODE_CONFIG = {
    ...
    reminder: {
      ...
      autoReturnMs: 3000,
      autoHintAfterMs: 0,
      difficultyOverride: "reminder_fixed",
  ...
  function getRuntimeConfig() {
    ...
    return {
      ...
      modeConfig: Object.assign({}, modeConfig, {
        ...
        showConditionCheck: normalizeBoolean(merged.show_condition_check, modeConfig.showConditionCheck),
        showFinishCheck: normalizeBoolean(merged.show_finish_check, modeConfig.showFinishCheck),
