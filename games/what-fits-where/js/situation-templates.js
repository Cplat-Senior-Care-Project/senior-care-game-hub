"use strict";
window.SITUATION_TEMPLATE_DATA = {
  "version": 1,
  "status": "applied",
  "templates": [
    {
    ...
    },
    {
      ...
      "questionPatterns": [
        "약국에서 처방전으로 약을 받고 결제와 연락도 하려고 해요. 필요한 물건을 골라주세요.",
        "약국에서 약을 받아 오고 결제, 연락까지 하려면 필요한 물건은 무엇일까요?",
        "약국 방문 전에 처방전과 결제, 연락에 필요한 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "처방전",
        "약",
    ...
    },
    {
      ...
      "situationName": "교회 예배",
      "questionPatterns": [
        "교회 예배에 가려고 해요. 성경과 개인 물건을 챙겨주세요.",
        "예배를 보러 갈 때 성경과 개인 물건 중 챙기면 좋은 것은 무엇일까요?",
        "교회에 가기 전 성경과 개인 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "성경",
        "지갑",
    ...
    },
    {
      ...
      "questionPatterns": [
        "강아지에게 밥과 물, 간식을 챙겨주려고 해요. 필요한 물건을 골라주세요.",
        "강아지에게 사료나 뼈다귀를 주고 물도 챙기려고 합니다. 필요한 물건을 골라주세요.",
        "강아지 밥과 물을 담아주고 간식도 주려고 해요. 필요한 물건을 골라주세요."
      ],
      "requiredPool": [
        "사료",
        "강아지 밥그릇",
    ...
    {
      "id": "school_delivery",
      "situationName": "학교 준비물 챙기기",
      "questionPatterns": [
        "책가방에 학교 준비물을 챙기려고 해요. 필요한 물건을 골라주세요.",
        "학교 가방에 넣을 준비물을 챙길 때 필요한 물건은 무엇일까요?",
        "학교 준비물을 챙기기 전 필요한 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "책가방",
        "공책",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "은행에서 계좌 업무와 결제, 연락에 필요한 물건은 무엇일까요?",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "우편물을 부치고 결제, 연락까지 하려면 필요한 물건은 무엇일까요?",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "비 오는 날 외출 시 챙겨야 할 물건을 골라주세요.",
        "비 오는 날 밖에 나갈 때 필요한 비 준비와 개인 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "우산",
        "장화",
    ...
    },
    {
      ...
      "questionPatterns": [
        "더운 여름을 시원하게 보내려고 해요. 필요한 물건을 골라주세요.",
        "햇빛이 강하고 더운 날에 필요한 물건은 무엇일까요?",
        "여름 더위에 대비할 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "모자",
        "선글라스",
    ...
    },
    {
      ...
      "questionPatterns": [
        "목욕이나 샤워를 하고 양치도 하려고 해요. 필요한 물건을 골라주세요.",
        "몸을 씻고 이를 닦을 때 무엇을 준비하면 좋을까요?",
        "씻기와 양치 전 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "비누",
        "샴푸",
    ...
    },
    {
      ...
      "situationName": "양치하기",
      "questionPatterns": [
        "양치하고 입가를 닦은 뒤 모습을 확인하려고 해요. 필요한 물건을 골라주세요.",
        "양치와 정리를 할 때 무엇을 준비하면 좋을까요?",
        "양치와 정리 전 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "칫솔",
        "치약",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "편하게 잠자리에 들고 밤에 필요한 물건을 가까이 두려면 무엇을 준비하면 좋을까요?",
        "잠자리와 밤중에 필요한 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "베개",
        "이불",
    ...
    },
    {
      ...
      "questionPatterns": [
        "라면을 끓여 먹으려고 해요. 필요한 물건을 골라주세요.",
        "라면을 만들고 먹을 때 무엇을 준비하면 좋을까요?",
        "라면을 끓여 먹기 전 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "라면",
        "냄비",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "그릇과 컵을 씻을 때 어떤 도구와 물건이 필요할까요?",
        "설거지할 그릇과 도구를 확인해 주세요."
      ],
      "requiredPool": [
        "주방용 세제",
        "수세미",
    ...
    },
    {
      ...
      "situationName": "방 청소",
      "questionPatterns": [
        "방을 쓸고 닦고 쓰레기도 정리하려고 해요. 필요한 물건을 골라주세요.",
        "바닥을 쓸고 닦고 쓰레기를 모을 때 무엇이 필요할까요?",
        "청소 전 도구와 쓰레기 정리 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "빗자루",
        "걸레",
    ...
    },
    {
      ...
      "questionPatterns": [
        "쓰레기를 정리하고 어두운 곳에서도 버릴 수 있게 준비하려고 해요. 필요한 물건을 골라주세요.",
        "쓰레기 정리와 분리수거, 어두운 곳 이동에 필요한 물건은 무엇일까요?",
        "쓰레기를 버리기 전 위생용품과 어두울 때 쓸 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "쓰레기통",
        "쓰레기봉투",
    ...
    },
    {
      ...
      "questionPatterns": [
        "복지관 프로그램에 참여하려고 해요. 수업과 이동에 필요한 물건을 골라주세요.",
        "회원 확인을 하고 수업을 들으러 복지관에 갈 때 필요한 준비물은 무엇일까요?",
        "복지관에 가기 전 회원증, 수업도구, 이동 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "회원증",
        "공책",
    ...
    },
    {
      ...
      "questionPatterns": [
        "미용실에 가려고 해요. 결제와 연락에 필요한 물건을 골라주세요.",
        "머리를 손질하러 미용실에 갈 때 필요한 개인 물건은 무엇일까요?",
        "미용실 방문 전 결제와 연락에 필요한 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "지갑",
        "마스크",
    ...
    },
    {
      ...
      "questionPatterns": [
        "수영장에 가서 물놀이하고 씻고 오려고 해요. 챙길 물건을 골라주세요.",
        "물놀이하고 씻고 돌아올 때 필요한 준비물은 무엇일까요?",
        "수영장에 가기 전 물놀이와 씻기에 필요한 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "수영복",
        "수건",
    ...
    },
    {
      ...
      "situationName": "정전 대비",
      "questionPatterns": [
        "정전이 되었을 때 밝히고 연락하고 필요한 물건을 챙기려고 해요. 골라주세요.",
        "불이 꺼져 어두울 때와 비상상황에 무엇을 준비하면 좋을까요?",
        "정전에 대비할 조명, 연락, 비상 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "손전등",
        "건전지",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "맡겨진 택배를 찾으러 이동하고 받을 때 필요한 준비물은 무엇일까요?",
        "택배를 찾기 전 본인 확인과 이동에 필요한 물건을 확인해 주세요."
      ],
      "requiredPool": [
        "신분증",
        "휴대폰",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "걸으며 음악을 듣고 편하게 산책할 때 필요한 준비물은 무엇일까요?",
        "음악 산책 전 기기와 산책 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "스마트폰",
        "이어폰",
