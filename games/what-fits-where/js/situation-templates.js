...
window.SITUATION_TEMPLATE_DATA = {
  ...
  "templates": [
    ...
    },
    {
      ...
      "questionPatterns": [
        "밭에 씨앗을 심으러 가려고 해요. 필요한 물건을 골라주세요.",
        "텃밭 일을 하러 갈 때 무엇을 챙기면 좋을까요?",
    ...
    {
      "id": "post_office_mail",
      "situationName": "우체국에서 편지 보내기",
      "questionPatterns": [
        "우체국에서 편지를 보내려고 해요. 필요한 물건을 골라주세요.",
        "편지를 부치러 갈 때 무엇을 챙기면 좋을까요?",
    ...
    },
    {
      ...
      "situationName": "방 청소",
      "questionPatterns": [
        "방을 청소하려고 해요. 필요한 물건을 골라주세요.",
        "바닥을 쓸고 닦을 때 무엇이 필요할까요?",
        "청소 전 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "빗자루",
    ...
    },
    {
      ...
      "questionPatterns": [
        ...
        "식물을 돌볼 때 무엇을 준비하면 좋을까요?",
        "화분을 가꾸기 전 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "화분",
        "물뿌리개",
    ...
    },
    {
      ...
      "questionPatterns": [
        "친구 집에 방문하려고 해요. 필요한 물건을 골라주세요.",
        "친구를 만나러 갈 때 무엇을 챙기면 좋을까요?",
        "친구 집에 가기 전 준비물을 확인해 주세요."
      ],
      "requiredPool": [
        "선물",
        "휴대폰",
